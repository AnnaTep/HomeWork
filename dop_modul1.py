...
spisok = {}
spisok.update({students_list[0] : sr_grades[0], students_list[1] : sr_grades[1], students_list[2] : sr_grades[2], students_list[3] : sr_grades[3], students_list[4] : sr_grades[4]})
print(spisok)
